        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 3, 25, 7, 26, 57, 574, DateTimeKind.Local).AddTicks(5214)),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2020, 3, 25, 7, 26, 57, 596, DateTimeKind.Local).AddTicks(1335), 100000m, 200000m });
